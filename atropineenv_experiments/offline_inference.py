...
try:
    for algo_name in algo_names:
        ...
        observations_list, actions_list, rewards_list = env.evalute_algorithms(algorithms, num_episodes=num_episodes, initial_states=initial_states, to_plt=False, plot_dir=save_dir)
